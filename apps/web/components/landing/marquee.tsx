...
const WORDS = ['EDGE', 'DISCIPLINE', 'PERFORMANCE', 'R-MULTIPLES', 'DRAWDOWN', 'TAUX DE RÉUSSITE', 'ESPÉRANCE', 'EDGE', 'DISCIPLINE', 'PERFORMANCE', 'R-MULTIPLES', 'DRAWDOWN', 'TAUX DE RÉUSSITE', 'ESPÉRANCE'];
